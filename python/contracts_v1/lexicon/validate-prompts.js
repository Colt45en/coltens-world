...
import { getOperatorSchema, listKnownOperatorTags } from "./promptOperatorRegistry.js";
...
function shouldCheckBySince(filePath, sinceIso) {
...
function main() {
  ...
  if (!target) {
    console.error(
      [
        "Usage:",
        "  node packages/engine/src/contracts/lexicon/validate-prompts.js <fileOrFolder> [--fail-on-unknown-tag] [--since=<ISO>] [--list-tags]",
        "",
        "Examples:",
        "  node .../validate-prompts.js docs/prompts",
        "  node .../validate-prompts.js docs/prompts --fail-on-unknown-tag",
        "  node .../validate-prompts.js docs/prompts --since=2026-02-12T00:00:00.000Z",
        "  node .../validate-prompts.js --list-tags"
      ].join("\n")
    );
    process.exit(2);
  }
