...
export const SimWorldMetadata = Envelope(z.object({
 ...
 */
export const SimInput = Envelope(z.object({
 ...
 */
export const SimSnapshot = Envelope(z.object({
 ...
 */
export const SimInputAck = Envelope(z.object({
