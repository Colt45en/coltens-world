...
export async function callSidecarEnrich(code, metrics, sessionId, topN = 32) {
    /**
...
export function handleFlowstateAnalyze(req, res) {
    ...
    req.on("end", () => {
        try {
            ...
            const metrics = computeFlowMetrics({ code, topN });
