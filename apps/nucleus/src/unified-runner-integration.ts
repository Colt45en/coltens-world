...
export async function runUnifiedPipelineWithBus(input: {
    ...
    for (let i = 0; i < stages.length; i++) {
        ...
        const completeEnv: BusEnvelopeV1 = {
            v: 1,
    ...
    // Emit run completed
    const runCompleteEnv: BusEnvelopeV1 = {
        v: 1,
 ...
 */
export function getTraceEnvelopes(traceId: string) {
 ...
 */
export function getTraceEnvelopesTail(traceId: string, limit: number) {
