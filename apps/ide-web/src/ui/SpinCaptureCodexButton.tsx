    ...
    return (
      <div className="space-y-3 p-3 border border-slate-300 rounded bg-slate-50">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          {/* Edge Angle */}
          <div>
            <label htmlFor="spin-edge-angle" className="block opacity-70 mb-1">Edge Angle (°)</label>
            <input
              id="spin-edge-angle"
              type="range"
              min={5}
          ...
          {/* SVG Size */}
          <div>
            <label htmlFor="spin-svg-size" className="block opacity-70 mb-1">SVG px</label>
            <input
              id="spin-svg-size"
              type="range"
              min={256}
          ...
          {/* PNG Size */}
          <div>
            <label htmlFor="spin-png-size" className="block opacity-70 mb-1">PNG px</label>
            <input
              id="spin-png-size"
              type="range"
              min={256}
          ...
          {/* Spin Speed */}
          <div>
            <label htmlFor="spin-speed" className="block opacity-70 mb-1">Speed (°/sec)</label>
            <input
              id="spin-speed"
              type="range"
              min={10}
          ...
          {/* Step */}
          <div>
            <label htmlFor="spin-step" className="block opacity-70 mb-1">Step (°)</label>
            <input
              id="spin-step"
              type="range"
              min={1}
          ...
          <div className="flex items-center gap-2">
            <input
              id="spin-transparency"
              type="checkbox"
              checked={ui.transparency}
              onChange={(e) => updateUi("transparency", e.target.checked)}
              className="w-4 h-4"
            />
            <label htmlFor="spin-transparency" className="opacity-70">Transparent BG</label>
          </div>

          {/* Preserve Rig */}
          <div className="flex items-center gap-2">
            <input
              id="spin-preserve-rig"
              type="checkbox"
              checked={ui.preserveRig}
              onChange={(e) => updateUi("preserveRig", e.target.checked)}
              className="w-4 h-4"
            />
            <label htmlFor="spin-preserve-rig" className="opacity-70">Preserve Rig/Materials</label>
          </div>
        </div>
