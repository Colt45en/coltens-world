        ...
        exporter.parse(
          ...
          (result) => {
            if (!(result instanceof ArrayBuffer)) {
              reject(new Error("GLTFExporter returned JSON payload; expected binary GLB output"));
              return;
            }
    ...
    <div className="space-y-3 p-3 border border-slate-300 rounded bg-slate-50">
      ...
      <div>
        ...
        <input
          ...
          title="Select heightmap file (PNG, JPG, or EXR)"
          onChange={(e) => {
      ...
      <div className="grid grid-cols-2 gap-2 text-xs">
        ...
        <div className="col-span-2">
          <label className="block opacity-70 mb-1">Name</label>
          <input
            type="text"
            value={cfg.name}
            onChange={(e) => updateCfg("name", e.target.value)}
            title="Heightfield name"
        ...
        {/* Grid Size */}
        <div>
          <label className="block opacity-70 mb-1">Grid Size</label>
          <input
            type="range"
            min={64}
            max={2048}
        ...
        {/* Height Scale */}
        <div>
          <label className="block opacity-70 mb-1">Height Scale</label>
          <input
            type="range"
            min={0.1}
            max={10}
        ...
        {/* Smooth Iterations */}
        <div>
          <label className="block opacity-70 mb-1">Smooth (Taubin)</label>
          <input
            type="range"
            min={0}
            max={20}
        ...
        {/* PNG Size */}
        <div>
          <label className="block opacity-70 mb-1">Thumbnail px</label>
          <input
            type="range"
            min={256}
            max={1024}
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-3 h-3"
          />
          <label className="opacity-70 text-xs cursor-pointer">Flip Y</label>
        </div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-3 h-3"
          />
          <label className="opacity-70 text-xs cursor-pointer">Invert</label>
        </div>
