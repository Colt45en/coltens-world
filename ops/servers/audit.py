...
def audit_tool_event(kind: str, trace_id: str, session_id: str, payload: Dict[str, Any]) -> None:
    append_ndjson(TOOL_EVENTS_PATH, {
        "kind": kind,
        "trace_id": trace_id,
...
def audit_desktop_action(kind: str, trace_id: str, session_id: str, payload: Dict[str, Any]) -> None:
    append_ndjson(DESKTOP_ACTIONS_PATH, {
        "kind": kind,
        "trace_id": trace_id,
        "session_id": session_id,
        "payload": payload,
