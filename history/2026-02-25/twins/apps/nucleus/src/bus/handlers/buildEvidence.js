import { BuildEvidenceRequestMsgSchema, EVT_BUILD_EVIDENCE_GENERATED, } from "@world-engine/protocol";
...
export async function handleBuildEvidenceBusMessage(app, raw) {
    ...
    const evidenceOutAbs = path.join(repoRootAbs, ".artifacts", "build-evidence", `${packet.id}.json`);
