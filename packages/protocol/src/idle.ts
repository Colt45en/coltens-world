...
export type IdleCommandV1Payload = z.infer<typeof IdleCommandV1PayloadSchema>;
...
export type IdleEffectV1Payload = z.infer<typeof IdleEffectV1PayloadSchema>;

// =============================================================================
// Augmented envelope types (type = "idle.command.v1" | "idle.effect.v1")
// =============================================================================
...
export type IdleGuardState = z.infer<typeof IdleGuardStateSchema>;
