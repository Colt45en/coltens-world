...
const CustomTaskType = z.string().regex(/^[a-z][a-z0-9_]*$/).refine((v) => !["lexicon_op", "hce_run", "scene", "analyze_sentence", "brain_control", "brain_train"].includes(v), { message: "Use enum for known task types" });
