...
export type IdeCliRunRequest = z.infer<typeof IdeCliRunRequestSchema>["payload"];
export type IdeCliRunResponse = z.infer<typeof IdeCliRunResponseSchema>["payload"];
...
export type IdeFsReadRequest = z.infer<typeof IdeFsReadRequestSchema>["payload"];
export type IdeFsReadResponse = z.infer<typeof IdeFsReadResponseSchema>["payload"];
